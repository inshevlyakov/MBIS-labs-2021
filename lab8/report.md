...
![Работа алгоритма](images/scr_8_1.png){ #fig:001 }
...
1. [Как в Python реализованы очень длинные числа типа integer?](https://habr.com/ru/company/otus/blog/489258/)
2. [Длинная арифметика](https://brestprog.by/topics/longarithmetics/)